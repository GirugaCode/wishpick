...
class UserOnBoardingViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    // MARK: PROPERTIES
    /// View Model for the User On Boarding
    lazy var viewModel: UserOnBoardingCollectionViewModel = {
       return UserOnBoardingCollectionViewModel()
    }()
    ...
    fileprivate func setupCollectionView() {
        ...
        collectionView?.register(UserOnBoardingCell.self, forCellWithReuseIdentifier: UserOnBoardingCell.identifier)
        collectionView?.isPagingEnabled = true
    }
    
    /// Creates the call to create the cells for user on boarding
    ...
    @objc private func handleNext() {
        let nextIndex = min(pageControl.currentPage + 1, viewModel.numberOfCells - 1)
...
extension UserOnBoardingViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView,
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: UserOnBoardingCell.identifier, for: indexPath) as! UserOnBoardingCell
        
        let cellViewModel = viewModel.getCellViewModel(at: indexPath)
        
        cell.UserOnBoardingCellViewModel = cellViewModel
